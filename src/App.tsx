...
function App() {
  ...
  const services = [
    ...
    },
    {
      ...
      description: "All major Android brands including Samsung, Google, OnePlus",
          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="flex-shrink-0 flex items-center">
                ...
                <span className="ml-2 text-xl font-bold text-gray-900">Hand2Hand Mobiles</span>
              </div>
            </div>
            ...
            <div className="hidden md:flex items-center space-x-4">
              <span className="text-gray-700 font-medium">Call: (555) 123-TECH</span>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-8 items-center">
            <div className="mb-8 lg:mb-0">
              ...
              <p className="text-xl text-gray-600 mb-8 leading-relaxed">
                Professional repair services for all your devices. Quick turnaround, 
                competitive prices, and a 90-day warranty on all repairs.
              </p>
            ...
            <div className="relative">
              ...
              <div className="absolute -bottom-6 -left-6 bg-white p-6 rounded-xl shadow-lg">
                <div className="flex items-center">
                  <div className="text-2xl font-bold text-blue-600 mr-2">4.9</div>
                ...
                <div className="text-sm text-gray-600 mt-1">500+ Happy Customers</div>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              We fix all major devices with high-quality parts and expert craftsmanship
            </p>
          </div>
          ...
          <div className="lg:grid lg:grid-cols-2 lg:gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-8">
                With over 2 years of experience in device repair, we've built a reputation 
                for quality service and customer satisfaction. Our certified technicians 
                use only genuine parts and the latest repair techniques.
              </p>
      ...
      <section id="process" className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Our simple 4-step process gets your device back to perfect condition
            </p>
          </div>
            ...
            <div className="bg-white rounded-2xl p-8 shadow-lg">
              ...
              <div className="space-y-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <div className="font-semibold text-gray-900">Visit Our Shop</div>
                    <div className="text-gray-600">Parippally road, Pallickal, Kerala 695604</div>
                  </div>
                </div>
                <div className="flex items-center">
                ...
                <div className="flex items-center">
                  ...
                  <div>
                    ...
                    <div className="text-gray-600">Mon-Fri: 9AM-7PM, Sat: 10AM-6PM</div>
                  </div>
                </div>
              </div>
            </div>
          ...
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center mb-4">
                ...
                <span className="ml-2 text-xl font-bold">Hand2Hand Mobiles</span>
              </div>
              <p className="text-gray-400">
                Your trusted partner for all device repairs. Quality service, competitive prices.
              </p>
            </div>
            <div>
